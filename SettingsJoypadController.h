...
@property (retain, nonatomic) IBOutlet UITableViewCell *CellX;
@property (retain, nonatomic) IBOutlet UITableViewCell *CellY;
@property (retain, nonatomic) IBOutlet UITableViewCell *CellL1;
@property (retain, nonatomic) IBOutlet UITableViewCell *CellL2;
@property (retain, nonatomic) IBOutlet UITableViewCell *CellR1;
@property (retain, nonatomic) IBOutlet UITableViewCell *CellR2;
@property (retain, nonatomic) IBOutlet UITableViewCell *CellUp;
