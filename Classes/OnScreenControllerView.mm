...
#import "OnscreenControllerView.h"
#import "debug.h"
#import "touchstick.h"
#import "CGVector.h"
...
OnScreenControllerView *sharedInstance;
...
- (void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event {
    ...
    if([_joypadstyle isEqualToString:kJoyStyleFourButton])
    {
        [self pushbuttonfour:&coordinates];
    }
    else
    {
        [self pushButtonOne:&coordinates];
    }
    
}

- (void)pushButtonFour:(CGPoint *)coordinates {
    ...
    //Button Y
    {
        [self.delegate didPushIOSJoystickButton];
...
-(NSString *)pushButtonOne:(CGPoint *)coordinates {
...
@interface OnScreenControllerView(PrivateMethods)
...
@interface OnScreenControllerView()
- (void)configure;
@end

@implementation OnScreenControllerView {
