...
@protocol StateManagementDelegate <NSObject>

- (void)onStateSave:(NSString *)stateFilePath;
- (void)onStateRestore:(NSString *)stateFilePath;
...
@property (nonatomic, assign) id<StateManagementDelegate> delegate;
